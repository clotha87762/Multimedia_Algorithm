...
imwrite(ori_gray,'averageDithering.jpg');
...
ori_gray = (ori_ex(2:size(ori_gray,1)+1,2:size(ori_gray,2)+1));
imwrite(ori_gray,'errorDiffusion1.jpg');
...
imwrite(ori_gray,'errorDiffusion2.jpg');
